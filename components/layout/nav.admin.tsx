// components/layout/nav.admin.tsx - Final Admin Navigation (Single Admin Area)
...
export const adminNav: NavItem[] = [
    ...
    { href: "/admin/studio/creators", label: "Creators", icon: <Icons.Brush /> },
...
/**
 * Studio-only nav (if needed separately)
 */
...
/**
 * Finance-only nav (if needed separately)
 */
