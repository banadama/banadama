// components/chat/MessageComposer.tsx - Chat Message Composer
"use client";
    ...
    return (
        <div style={{ display: "flex", gap: 10 }}>
            <input
                ...
                style={{ flex: 1 }}
            />
            <button className="bd-btn bd-btn-primary" onClick={send} disabled={loading} style={{ flexShrink: 0 }}>
                <Icons.Send size={18} /> {loading ? "..." : "Send"}
            </button>
        </div>
    );
}
