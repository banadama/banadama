...
export default function FactoryPurchaseOrdersPage() {
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-slate-400 mt-1">Your assigned orders from buyers</p>
            </div>
                ...
                <>
                    {orders.length === 0 ? (
                        <div className="text-center py-12 rounded-xl border border-slate-800 bg-slate-900/40">
                            ...
                            <p className="text-xs text-slate-500 mt-1">Orders assigned to you will appear here</p>
                        </div>
                    ) : (
                                    ...
                                    {orders.map((order) => (
                                        <tr key={order.id} className="hover:bg-slate-800/30 transition-colors">
                                            ...
                                            <td className="px-4 py-3 text-right">
                                                <Link
                                                    href={`/factory/purchase-orders/${order.id}`}
