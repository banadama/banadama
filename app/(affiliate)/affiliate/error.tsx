// app/(affiliate)/affiliate/error.tsx - Affiliate Error Boundary
"use client";

import * as React from "react";
import { Icons } from "@/components/icons/icons";

export default function AffiliateError({ reset }: { reset: () => void }) {
    return (
        <div className="bd-card bd-card-pad" style={{ display: "grid", gap: 10 }}>
            <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                <Icons.Warning size={18} style={{ color: "var(--bd-danger)" }} />
                <div style={{ fontWeight: 950 }}>Affiliate page error</div>
            </div>
